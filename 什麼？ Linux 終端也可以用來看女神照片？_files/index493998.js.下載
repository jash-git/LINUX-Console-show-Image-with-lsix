...
var o=L[e],i=_.attr(o,"data-showed");
if("no"==i){
...
function a(e){
try{
for(var i=window.pageYOffset||document.documentElement.scrollTop,a=0;a<L.length;a+=N){
var m=L[a];
...
var a=L[e.product_list[i].index],m=e.product_list[i].template_id;
